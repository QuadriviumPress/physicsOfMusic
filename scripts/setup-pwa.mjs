...
// MyST copies project.static_files both to the public root and under /build.
// H5P embeds use the stable /h5p URL, so the second copy is unreachable and
// would otherwise nearly double the H5P portion of every deployment.
