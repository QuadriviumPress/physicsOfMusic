#!/usr/bin/env python3
"""Turn the LaTeX export of *Physics of Music* into a Word document.
...
def main() -> int:
    ...
    parser.add_argument(
        "--tex-dir",
        type=Path,
        default=Path("exports/physics-of-music_pdf_tex"),
        help="directory holding the MyST LaTeX export (default: %(default)s)",
    )
    parser.add_argument(
        "--master",
        default="physics-of-music.tex",
        help="master .tex file inside --tex-dir (default: %(default)s)",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("exports/physics-of-music.docx"),
