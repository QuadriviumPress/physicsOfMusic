#!/usr/bin/env bash
#
# Build every printable edition of *Physics of Music* into exports/.
#
#   physics-of-music.pdf           the whole book, worked solutions included
#   physics-of-music-student.pdf   the whole book, exercises but no solutions
#   physics-of-music.docx          the complete edition as a Word document
...
build_book() {
  ...
  # files would also rebuild all fifteen offprints.
