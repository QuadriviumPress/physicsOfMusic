# Open image attributions

These images are supplementary illustrations. They are locally cached from
Wikimedia Commons so the book builds without remote requests. The source page
is the authoritative record for the file and its license.

| Local file | Source | License | Credit |
|---|---|---|---|
